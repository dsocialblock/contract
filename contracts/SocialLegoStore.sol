...
contract onlineStore is KeeperCompatibleInterface, Ownable {
    ...
    IERC20 socialLegoToken = IERC20(0xAe0f650F39B943F738a790519C3556bf6f8C92F1);   //adress of SocialLego token
    ...
    function buyMassiveTokens() public payable{ // how many tokens they want to purchase
        require(socialLegoToken.balanceOf(address(this)) >= 1000000*10**10,"Not Enought Tokens in Contract"); // require this contract to have at least 1,000,000 tokens before executing
    ...
    function buyLargeTokens() public payable{ // how many tokens they want to purchase
        require(socialLegoToken.balanceOf(address(this)) >= 100000*10**10,"Not Enought Tokens in Contract"); // require this contract to have at least 1,000,000 tokens before executing
    ...
    function buyMediumTokens() public payable{ // how many tokens they want to purchase
        require(socialLegoToken.balanceOf(address(this)) >= 20000*10**10,"Not Enought Tokens in Contract"); // require this contract to have at least 1,000,000 tokens before executing
    ...
    function buySmallTokens() public payable{ // how many tokens they want to purchase
        require(socialLegoToken.balanceOf(address(this)) >= 10000*10**10,"Not Enought Tokens in Contract"); // require this contract to have at least 1,000,000 tokens before executing
